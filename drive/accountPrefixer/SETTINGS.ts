...
let FOLDERS = {
	...
	inventum_shanghai: `1sAHYA3u0ZrbzuQTAfr6FuQPrqnetwsNR`
};

// KEY refers to Account Identifier, which can be either
// shorthandAccountNames MODE e.g. source folder name: `Inventum Digital` converts to `0086-ID Inventum Digital`
